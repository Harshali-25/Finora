  ...
  const fetchData = useCallback(async () => {
    ...
    try {
      ...
      const [hRes, oRes, pRes, aRes] = await Promise.all([
        fetch("https://finora-a50c.onrender.com/allHoldings", { headers }),
        fetch("https://finora-a50c.onrender.com/allOrders", { headers }),
        fetch("https://finora-a50c.onrender.com/allPositions", { headers }),
        fetch("https://finora-a50c.onrender.com/allAlerts", { headers }) 
      ]);
      ...
      const marketRes = await fetch("https://finora-a50c.onrender.com/api/marketData", {
        method: "POST",
        headers,
